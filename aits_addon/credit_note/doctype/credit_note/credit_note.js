...
erpnext.accounts.taxes.setup_tax_validations("Credit Note");
erpnext.accounts.payment_triggers.setup("Credit Note");
erpnext.accounts.pos.setup("Credit Note");
